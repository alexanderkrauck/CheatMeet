...
with open('src/lib/audioMerge.ts', 'r') as f:
    content = f.read()

new_merge = '''export function mergeAudioStreams(stream1: MediaStream, stream2: MediaStream | undefined): MediaStream {
...
with open('src/lib/audioMerge.ts', 'w') as f:
    f.write(new_merge)
